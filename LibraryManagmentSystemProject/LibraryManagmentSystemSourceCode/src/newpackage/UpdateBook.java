...
public class UpdateBook extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 80, 60, -1));
        ...
        getContentPane().add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 320, 250, -1));
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 320, 90, -1));
        ...
        getContentPane().add(jTextField7, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 120, 250, -1));

        jLabel7.setBackground(new java.awt.Color(255, 255, 204));
        jLabel7.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel7.setText("Old ID");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 120, 70, -1));

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/newpackage/123456.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String OldID =  jTextField7.getText();

        Book m = new Book(NewID,Title,Availability,Author,Genre,ISBN);
        ...
        try {
            ...
            String query = "UPDATE book SET ID = ?, Title = ?, Author = ?, genre = ?, ISBN= ?, Availability= ? WHERE ID = ?";
           
            PreparedStatement pst = con.prepareStatement(query);
            pst.setString(1,ID2());
            pst.setString(2,Title2());
            pst.setString(3,m.Author2());
            pst.setString(4,m.Genre2());
            pst.setString(5,m.ISBN1());
            pst.setString(6,Availability2());
            pst.setString(7, OldID);  // For the WHERE clause
