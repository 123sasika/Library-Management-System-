...
public class ReturnDVD extends javax.swing.JFrame {
    ...
    DefaultTableModel tableModel;
        ...
        try{
            ...
            String dvdQuery = "select ID,Title,BorrowerName from returndvd";    // Query for books table
            ...
            ResultSet dvdRs = dvdStmt.executeQuery();
             ...
             //custom exception
            if(!dvdRs.next()){
                throw new DVDDetailsNotFoundException("DVD was not loaded");
            }
        ...
        catch(DVDDetailsNotFoundException e){
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 440, 10, 10));
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        try {
            ...
            if (rs.next()) {
                ...
                //custom exception
                throw new DVDDetailsNotFoundException("No record found for the selected DVD ID!");
            }
    ...
    private void jPanel1AncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_jPanel1AncestorAdded
        ...
        try {
            ...
            //custom exception
            if(!rs.next()){
                throw new JpanelNotLoadException("DVD is not available to load");
            }
            while (rs.next()) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Item item=new DVD("", "", "", "", "");
        item.returnItem((String) jComboBox1.getSelectedItem(),jTextField1.getText(),jTextField2.getText(),"DVD1");  
       ...
       //updating the table of this page
        try{
            ...
            int Update=st.executeUpdate("insert into returndvd values('"+id+"','"+title+"','"+borrower+"')");
            
            //custom exception
            if (Update== 0) {
                throw new DVDNotFoundException("DVD was not found");
            } else {
        ...
        loadData();
         ...
         //updating availability of the dvd table  
         try {
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/library","root","");
            ...
            if (rowsUpdated > 0) {
                JOptionPane.showMessageDialog(null, "DVD availability was updated successfully!");
            } else {
               //custom exception
                 throw new NotUpdatingAvailabilityException("DVD availability was not updated successfully!");            }
